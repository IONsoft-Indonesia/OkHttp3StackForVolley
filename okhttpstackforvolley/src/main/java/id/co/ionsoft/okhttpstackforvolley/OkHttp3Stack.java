...
/**
 * OkHttp stack that can be used to change default stack of Volley
 * {@link com.android.volley.toolbox.HttpStack HttpStack} to increase performance
 *
 * @author hendrawd
 * @since 1.0
 */
...
public class OkHttp3Stack implements HttpStack {
    ...
    private static RequestBody createRequestBody(Request request) throws AuthFailureError {
        ...
        if (body == null) {
            ...
            // so we will return RequestBody.create(MediaType.parse(response.getBodyContentType()), "")
            // instead of null
            return RequestBody.create(MediaType.parse(request.getBodyContentType()), "");
        }
